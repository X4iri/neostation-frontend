...
const Map<String, dynamic> appLocaleJa = {
  ...
  AppLocale.showAppsTab: 'アプリタブを表示',
  AppLocale.showAppsTabSubtitle: 'ナビゲーションバーにアプリタブを表示する',
  ...
  AppLocale.apps: 'アプリ',
  AppLocale.appInfo: 'アプリ情報',
  AppLocale.uninstall: 'アンインストール',
  AppLocale.addToFavorites: 'お気に入りに追加',
  AppLocale.removeFromFavorites: 'お気に入りから削除',

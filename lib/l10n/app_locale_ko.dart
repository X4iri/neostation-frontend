...
const Map<String, dynamic> appLocaleKo = {
  ...
  AppLocale.showAppsTab: '앱 탭 표시',
  AppLocale.showAppsTabSubtitle: '탐색 메뉴에 앱 탭을 표시합니다',
  ...
  AppLocale.apps: '앱',
  AppLocale.appInfo: '앱 정보',
  AppLocale.uninstall: '제거',
  AppLocale.addToFavorites: '즐겨찾기에 추가',
  AppLocale.removeFromFavorites: '즐겨찾기에서 제거',
